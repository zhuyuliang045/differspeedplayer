...
#include "../DiffSpeedPlayer/videoplayer.h"
...
QT_MOC_LITERAL(1, 12, 13), // "sigVideoFrame"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7) // "pPixmap"

    },
    "VideoPlayer\0sigVideoFrame\0\0pPixmap"
};
...
void VideoPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (VideoPlayer::*)(QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoPlayer::sigVideoFrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoPlayer::sigVideoFrame(QPixmap _t1)
{
