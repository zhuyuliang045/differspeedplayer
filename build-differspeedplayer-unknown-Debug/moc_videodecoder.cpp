...
#include "../DiffSpeedPlayer/videodecoder.h"
...
QT_MOC_LITERAL(1, 13, 13), // "sigVideoFrame"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7) // "pPixmap"

    },
    "VideoDecoder\0sigVideoFrame\0\0pPixmap"
};
...
void VideoDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigVideoFrame((*reinterpret_cast< QPixmap(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VideoDecoder::*)(QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoDecoder::sigVideoFrame)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject VideoDecoder::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_VideoDecoder.data,
      qt_meta_data_VideoDecoder,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void VideoDecoder::sigVideoFrame(QPixmap _t1)
{
